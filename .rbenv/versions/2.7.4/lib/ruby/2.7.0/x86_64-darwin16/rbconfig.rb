...
module RbConfig
  ...
  TOPDIR = File.dirname(__FILE__).chomp!("/lib/ruby/2.7.0/x86_64-darwin16")
  ...
  CONFIG["EXEEXT"] = ""
  CONFIG["prefix"] = (TOPDIR || DESTDIR + "/Users/Fays/.rbenv/versions/2.7.4")
  ...
  CONFIG["configure_args"] = " '--prefix=/Users/Fays/.rbenv/versions/2.7.4' '--with-openssl-dir=/Users/Fays/.rbenv/versions/2.7.4/openssl' '--enable-shared' '--with-readline-dir=/usr/local/opt/readline' '--with-libyaml-dir=/usr/local/opt/libyaml' 'CC=clang' 'CFLAGS= -O3 -Wno-error=shorten-64-to-32 ' 'LDFLAGS=-L/Users/Fays/.rbenv/versions/2.7.4/lib ' 'CPPFLAGS=-I/Users/Fays/.rbenv/versions/2.7.4/include '"
  ...
  CONFIG["RUBY_EXEC_PREFIX"] = "/Users/Fays/.rbenv/versions/2.7.4"
  ...
  CONFIG["STATIC"] = ""
  CONFIG["ARCH_FLAG"] = ""
  CONFIG["DLDFLAGS"] = "-L/Users/Fays/.rbenv/versions/2.7.4/lib  -Wl,-undefined,dynamic_lookup -Wl,-multiply_defined,suppress"
  CONFIG["ALLOCA"] = ""
  CONFIG["MATHN"] = "yes"
  ...
  CONFIG["CPP"] = "$(CC) -E"
  CONFIG["OBJEXT"] = "o"
  CONFIG["CPPFLAGS"] = "-I/Users/Fays/.rbenv/versions/2.7.4/include  -D_XOPEN_SOURCE -D_DARWIN_C_SOURCE -D_DARWIN_UNLIMITED_SELECT -D_REENTRANT $(DEFS) $(cppflags)"
  CONFIG["LDFLAGS"] = "-L. -L/Users/Fays/.rbenv/versions/2.7.4/lib  -fstack-protector-strong -L/usr/local/lib"
  CONFIG["CFLAGS"] = " -O3 -Wno-error=shorten-64-to-32  -fno-common -pipe"
  CONFIG["CC"] = "clang"
